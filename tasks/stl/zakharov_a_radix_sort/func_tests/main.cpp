...
TEST(Zakharov_a_radix_sort_stl, Positive) {
  const int count = 7;
  ...
  // Create Task
  ZakharovRadixSortSTL testTaskSTL(taskDataSTL);
...
TEST(Zakharov_a_radix_sort_stl, Negative) {
  const int count = 10;
...
TEST(Zakharov_a_radix_sort_stl, Sorted) {
  const int count = 11;
...
TEST(Zakharov_a_radix_sort_stl, ReversSorted) {
  const int count = 9;
...
TEST(Zakharov_a_radix_sort_stl, DuplicateValues) {
  const int count = 12;
...
TEST(Zakharov_a_radix_sort_stl, IdenticalElements) {
  const int count = 6;
